...
abstract class FlutterFlowTheme {
  ...
  late Color inativeTab;
  late Color activeTab;
  late Color borderIcons;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color inativeTab = Color(0x67000000);
  late Color activeTab = Color(0xFFE05946);
  late Color borderIcons = Color(0x4D000000);
}
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color inativeTab = Color(0x67FFFFFF);
  late Color activeTab = Color(0xFFE05946);
  late Color borderIcons = Color(0xFFDDDDDD);
}
